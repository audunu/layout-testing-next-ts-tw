...
function Circle() {
  return (
  <div className='relative h-[200px] mb-10 w-[200px] self-center'>
    
    <div className='absolute text-sm text-white top-0 bg-opacity-40 rounded-[50%] h-[200px] w-[200px] bg-black'>
